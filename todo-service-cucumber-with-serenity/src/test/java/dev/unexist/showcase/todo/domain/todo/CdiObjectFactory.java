...
public class CdiObjectFactory implements ObjectFactory {
    ...
    private SerenityObjectFactory serenityObjectFactory;

    public CdiObjectFactory() {
        this.serenityObjectFactory = new SerenityObjectFactory();
        startApplication();
    }

    public void start() {
        this.serenityObjectFactory.start();
    }

    public void stop() {
        this.serenityObjectFactory.stop();
    }

    public boolean addClass(Class<?> stepClass) {
        this.serenityObjectFactory.addClass(stepClass);
